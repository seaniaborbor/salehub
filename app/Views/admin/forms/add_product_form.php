...
<form method="post" action="/dashboard/products/" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <input type="text" class="form-control border-success" id="prodName" name="prodName">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control border-success" id="prodSize" name="prodSize">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control border-success" id="prodPrice" name="prodPrice">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control border-success" id="prodQty" name="prodQty">
